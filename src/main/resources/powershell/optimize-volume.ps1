...
function SelectAction {
    ...
    switch ($m.ToUpper()) {
        ...
        # Optimize-Volume has no lighter-defrag switch (ReGatheringFlags is not a parameter).
        'FAST'       { return @{ Cmd = "Optimize-Volume -DriveLetter $drive -Defrag -Verbose"; Phases = 2 } }
