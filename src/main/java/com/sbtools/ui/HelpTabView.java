...
public class HelpTabView extends VBox {
    ...
    public HelpTabView() {
        ...
        getChildren().add(createFaqSection("Disk tools",
                ...
                "Defrag: click \"Refresh\", select visible drives (Filter All / HDD / SSD applies to Analyze / Intelligent Defrag), click \"Analyze Selected\", then \"Intelligent Defrag\" (Mode Auto / Quick / Deep). Full defrag runs only on confirmed HDDs; SSDs and unknown media get ReTrim. Quick and Full both run Optimize-Volume -Defrag on HDDs (Windows has no lighter switch); Deep adds free-space consolidation. A color-coded grid visualizes fragmentation. Intelligent Defrag requires admin. " +
